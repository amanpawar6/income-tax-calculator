...
/** New regime slabs before Budget 2025 (6 bands). */
...
export const fy202425: TaxRulesConfig = {
  id: 'fy-2024-25',
  ...
  newRegime: {
    slabs: NEW_SLABS_FY2425,
    standardDeductionSalaried: 75_000,
    section87A: { maxTaxableIncome: 700_000, maxRebate: 25_000 },
